...
function wpspf_get_paymentgateway_field_view(){
    ...
    if(get_option('wpspfnet_enable')==1){
	    $fieldHtml .='<tr id="wpspf_credit_card_logo"><td></td><td style="text-align:right;padding: 10px;"><img src="' . plugin_dir_url(__FILE__) . 'img/credit-card-logo.png" width="235" height="35" border=0 alt="Credit Card Logos" /></td></tr>';
	}
