...
function essence_enqueue_scripts_styles() {
	...
	wp_enqueue_style(
		'jquery-ui-style',
		get_stylesheet_directory_uri() . '/jquery-ui.min.css',
		[],
		genesis_get_theme_version()
	);
	...
	wp_enqueue_script(
		'jquery-ui',
		get_stylesheet_directory_uri() . '/js/jquery-ui.min.js',
		[ 'jquery' ],
		genesis_get_theme_version(),
		true
	);
	...
	wp_enqueue_script(
		...
		get_stylesheet_directory_uri() . '/js/jquery.formatCurrency-1.4.0.min.js',
		[ 'jquery' ],
		genesis_get_theme_version(),
		true
	);
	...
	wp_enqueue_script(
		'local-js',
		get_stylesheet_directory_uri() . '/js/local.js',
		[ 'jquery' ],
		genesis_get_theme_version(),
		true
	);
